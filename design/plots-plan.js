...
function block(ids, x0, y0, w, h, gap) {
...
export const PLOTS = [
  ...
  ours: p.id === OUR_STORE,
  size: p.w * p.h > 4200 ? 'Large' : p.w * p.h > 2600 ? 'Medium' : 'Small'
}));
...
export const SQFT = { Small: 2500, Medium: null, Large: null };

export const DISTRICT_OF = id =>
